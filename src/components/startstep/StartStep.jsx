    ...
    <div className="bg-[#f9fafc]">
      <div className="container mx-auto text-center pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-10 bg-gray-50">
          <div className="relative bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
            <span className="absolute top-4 right-4 bg-[#7D26CD] text-white text-xs font-bold h-7 w-7 flex items-center justify-center rounded-full">
              01
            </span>
